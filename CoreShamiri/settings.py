"""
Django settings for CoreShamiri project.
...
SECRET_KEY = 'django-insecure-c%0#$w4)8cfi-8@b)7m)8r0&g5sx*@mz++^v8^p-#dxw^b1!#h'
...
AUTH_USER_MODEL = 'CoreTherapy_user.User'
...
WSGI_APPLICATION = 'CoreShamiri.wsgi.application'
